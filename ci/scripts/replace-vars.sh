...
sed dp-dd-frontend-controller/appspec.yml dp-dd-frontend-controller/scripts/codedeploy/* -i \
...
cp dp-dd-frontend-controller/appspec.yml artifacts/
cp dp-dd-frontend-controller/scripts/codedeploy/* artifacts/scripts/codedeploy
